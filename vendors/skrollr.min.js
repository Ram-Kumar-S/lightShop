...
!(function (a, b, c) {
  ...
  (d.prototype.refresh = function (a) {
    ...
    (d.prototype.getScrollTop = function () {
      return Sa
        ? Ta
        : a.pageYOffset || e.scrollTop || f.scrollTop || 0;
    }),
  ...
  var X = function () {
      ...
      wa(e, [k, l, m, n].join(' '), function (a) {
        ...
        switch (
          ...
          (p = e.clientX),
          (t = a.timeStamp),
          G.test(j.tagName) || a.preventDefault() || a.type)
        ) {
          case k:
            d && d.blur(),
              ha.stopAnimateTo(),
        ...
        for (
          ...
          (h = d[f]),
            ...
            'relative' === h.mode &&
              (fa(b),
              (h.frame =
                ha.relativeToAbsolute(c, h.anchors[0], h.anchors[1]) -
                l),
              fa(b, !0)),
            (h.frame += m),
          ...
          switch (
            (t
              ...
              : (Ea(j, [r], [p, q]),
                w &&
                  m > x &&
                  (za(j, s.eventType, La), (i.lastFrameIndex = m))),
            (i.edge = t ? -1 : 1),
            i.edgeStrategy)
          ) {
            case 'reset':
